# CASO Web - Cours 5 - Hiérarchie HTML, Selecteurs CSS, Display flex [DESGIN INDUSTRIEL]
Le site bleu blanc rouge qui vous montre bien l’importance de la hiérarchie et des sélecteurs en CSS.
Cette page démontre comment:
...
- comment on sélectionne plusieurs éléments ensemble
- comment on se sert de plusieurs classes sur un même élément pour ajuster le comportement du CSS
